...
export const getGetItemsMock = () => ({data: [...Array(faker.datatype.number({min: 1, max: 10}))].map(() => ({finishedAt: faker.random.arrayElement([faker.random.word(), undefined]), scanningAt: faker.random.arrayElement([faker.random.word(), undefined]), queuedAt: faker.random.word(), findings: [...Array(faker.datatype.number({min: 1, max: 10}))].map(() => ({metadata: {severity: faker.random.arrayElement(Object.values(Severity)), description: faker.random.word()}, location: {positions: {begin: {line: faker.datatype.number()}}, path: faker.random.word()}, ruleId: faker.random.word(), type: faker.random.word(), itemId: faker.random.word(), id: faker.random.word()})), repositoryName: faker.random.word(), status: faker.random.arrayElement(Object.values(ItemStatus)), id: faker.random.word()}))})

export const getGetItemMock = () => ({data: {finishedAt: faker.random.arrayElement([faker.random.word(), undefined]), scanningAt: faker.random.arrayElement([faker.random.word(), undefined]), queuedAt: faker.random.word(), findings: [...Array(faker.datatype.number({min: 1, max: 10}))].map(() => ({metadata: {severity: faker.random.arrayElement(Object.values(Severity)), description: faker.random.word()}, location: {positions: {begin: {line: faker.datatype.number()}}, path: faker.random.word()}, ruleId: faker.random.word(), type: faker.random.word(), itemId: faker.random.word(), id: faker.random.word()})), repositoryName: faker.random.word(), status: faker.random.arrayElement(Object.values(ItemStatus)), id: faker.random.word()}})

export const getCreateItemMock = () => ({data: {finishedAt: faker.random.arrayElement([faker.random.word(), undefined]), scanningAt: faker.random.arrayElement([faker.random.word(), undefined]), queuedAt: faker.random.word(), findings: [...Array(faker.datatype.number({min: 1, max: 10}))].map(() => ({metadata: {severity: faker.random.arrayElement(Object.values(Severity)), description: faker.random.word()}, location: {positions: {begin: {line: faker.datatype.number()}}, path: faker.random.word()}, ruleId: faker.random.word(), type: faker.random.word(), itemId: faker.random.word(), id: faker.random.word()})), repositoryName: faker.random.word(), status: faker.random.arrayElement(Object.values(ItemStatus)), id: faker.random.word()}})
